...
;;(defvar my:ycmd-server-command '("python" "/home/mikhail/Research/ycmd/ycmd"))
...
(defvar my:jupyter_start_dir "/home/mikhail")
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zzz-to-char yasnippet-snippets yapfify yaml-mode writegood-mode window-numbering which-key wgrep web-mode vlf use-package string-inflection sourcerer-theme realgud rainbow-delimiters powerline origami multiple-cursors modern-cpp-font-lock markdown-mode magit-gerrit json-mode hungry-delete google-c-style git-gutter flyspell-correct-ivy flycheck-ycmd flycheck-pyflakes elpy ein edit-server cuda-mode counsel-etags company-ycmd company-jedi cmake-font-lock clang-format beacon bazel-mode autopair auto-package-update auctex))))
